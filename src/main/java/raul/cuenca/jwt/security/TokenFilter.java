...
//		proteger el dato valioso del token con final -> static
		...
		if (tokenHeader != null && tokenHeader.startsWith("Bearer ")) {
			...
			logger.warn("Error: Token inválido");
		}
		...
		if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
			...
			if (util.validateToken(token, user)) {
				...
				UsernamePasswordAuthenticationToken usernameToken = new UsernamePasswordAuthenticationToken(username,
